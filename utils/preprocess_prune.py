...
from utils.graph_prune import generate_adj_data_from_grounded_concepts
...
output_paths = {
    ...
    'csqa': {
        ...
        'graph': {
            'adj-train': './data/csqa/graph_prune/train.graph.adj.pk',
            'adj-dev': './data/csqa/graph_prune/dev.graph.adj.pk',
            'adj-test': './data/csqa/graph_prune/test.graph.adj.pk',
        },
    },
    'obqa': {
        'statement': {
        ...
        'graph': {
            'adj-train': './data/obqa/graph_prune/train.graph.adj.pk',
            'adj-dev': './data/obqa/graph_prune/dev.graph.adj.pk',
            'adj-test': './data/obqa/graph_prune/test.graph.adj.pk',
        },
    },
    'obqa-fact': {
        'statement': {
...
def main():
    ...
    parser.add_argument('--prune', type=float, default=0.9, help='threshold for pruning paths')
    ...
    routines = {
        ...
        'csqa': [
            ...
            {'func': generate_adj_data_from_grounded_concepts, 'args': (output_paths['csqa']['grounded']['train'], output_paths['cpnet']['pruned-graph'], output_paths['cpnet']['vocab'], output_paths['csqa']['graph']['adj-train'].format(prune), args.nprocs, prune)},
            {'func': generate_adj_data_from_grounded_concepts, 'args': (output_paths['csqa']['grounded']['dev'], output_paths['cpnet']['pruned-graph'], output_paths['cpnet']['vocab'], output_paths['csqa']['graph']['adj-dev'].format(prune), args.nprocs, prune)},
            {'func': generate_adj_data_from_grounded_concepts, 'args': (output_paths['csqa']['grounded']['test'], output_paths['cpnet']['pruned-graph'], output_paths['cpnet']['vocab'], output_paths['csqa']['graph']['adj-test'].format(prune), args.nprocs, prune)},
        ],
        ...
        'obqa': [
            ...
            {'func': generate_adj_data_from_grounded_concepts, 'args': (output_paths['obqa']['grounded']['train'], output_paths['cpnet']['pruned-graph'], output_paths['cpnet']['vocab'], output_paths['obqa']['graph']['adj-train'].format(prune), args.nprocs, prune)},
            {'func': generate_adj_data_from_grounded_concepts, 'args': (output_paths['obqa']['grounded']['dev'], output_paths['cpnet']['pruned-graph'], output_paths['cpnet']['vocab'], output_paths['obqa']['graph']['adj-dev'].format(prune), args.nprocs, prune)},
            {'func': generate_adj_data_from_grounded_concepts, 'args': (output_paths['obqa']['grounded']['test'], output_paths['cpnet']['pruned-graph'], output_paths['cpnet']['vocab'], output_paths['obqa']['graph']['adj-test'].format(prune), args.nprocs, prune)},
        ],

        'obqa-fact': [
            {'func': convert_to_obqa_statement, 'args': (input_paths['obqa-fact']['train'], output_paths['obqa-fact']['statement']['train'], output_paths['obqa-fact']['statement']['train-fairseq'])},
            {'func': convert_to_obqa_statement, 'args': (input_paths['obqa-fact']['dev'], output_paths['obqa-fact']['statement']['dev'], output_paths['obqa-fact']['statement']['dev-fairseq'])},
            {'func': convert_to_obqa_statement, 'args': (input_paths['obqa-fact']['test'], output_paths['obqa-fact']['statement']['test'], output_paths['obqa-fact']['statement']['test-fairseq'])},
        ]
    }
